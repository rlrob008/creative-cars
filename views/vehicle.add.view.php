...
<div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
                <a href="#" class="navbar-brand">Creative Cars - Add Vehicle</a>
            ...
            <div class="row">
                <div class="col-12 text-center">
                        <h1 class="h1">Creative Cars - Add Vehicle</h1>
                </div>
            </div>

            <div class="row mt-5 justify-content-center">
                <div class="col-md-6">
                <form id="formMotorVehicle" class="form" action="includes/vehicle.add.inc.php" method="POST">
                    <div class="row m-2">
